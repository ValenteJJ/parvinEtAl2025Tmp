...
setwd("C:/ValenteGitHub/ICP/Lucas Data Exploration/Point Count Methodology/wothSimulations/results/Dens0.05_Detect0.3")
...
for (i in 1:1000) { 
  ...
  file_name <- paste0("Occ.05Detect.3Results", i, ".csv")
...
write.csv(combined_results_summary, file = "Full_Results_Summary.05.3.csv", row.names = FALSE)
